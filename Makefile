...
CROSS_COMPILE:=/opt/MentorGraphics/Sourcery_CodeBench_Lite_for_ARM_EABI/bin/arm-none-eabi-
...
CFLAGS=-mcpu=cortex-a15 -I../linux_header_313_arm/include -O0 -marm -g -ggdb
...
LDFLAGS+=-L../arm-linux-uclibc/usr/lib -L/opt/MentorGraphics/Sourcery_CodeBench_Lite_for_ARM_EABI/lib/gcc/arm-none-eabi/4.8.1
